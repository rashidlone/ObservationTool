    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h1 class="card-title" style=""><b style="font-size:30px;"> &nbsp; Edit Observation Toolset &nbsp; </b></h1>
...
<!--here will be form body-->
              ...
              <form method="post" id="edit_observation_toolset_form">
...
$(function () {
  ...
  $('#edit_observation_toolset_form').validate({
    rules: {
      observation_title: {
        required: true,
      },
